...
$(link).trigger('click');}
hljs.initHighlightingOnLoad();},toggleSubMenu:function(){var subMenu=$(this).next('.menu__submenu');var arrow=$(this).children('.menu__link-arrow');if($(subMenu).is(':hidden')){$(subMenu).slideDown('fast');$(arrow).html('&#9650;');}
