<div class="info">
	<h1 id="/tech">Технические вопросы</h1>
	
	<h2 id="/tech-tools">Отладка</h2>
	<p>Для разработки я предпочитаю использовать Mozilla Firefox. Для этого браузера есть великолепное дополнение Firebug, которое сильно облегчает работу с фронтендом. Ещё для отладки в этом браузере я использовал дополнение просмотра HTTP заголовков. Так же, есть хорошее дополнение Web Developer Toolbar.</p>
...
print(count)</code></pre>
    ...
    <p>Был 2007 год и первый язык программирования, который я изучил — был QBasic. Его знание требовалось для вступительных экзаменов в университет. Благодаря этому, сильно заинтересовался программированием и самостоятельно изучал Visual Basic.</p>
